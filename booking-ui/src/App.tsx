...
function HeroSection() {
  return (
    <section className="space-y-6">
      {/* ラベル */}
      <div className="inline-flex items-center rounded-full bg-slate-900/80 px-3 py-1 text-xs font-semibold text-amber-300">
      ...
      <div className="space-y-3">
        <h1 className="text-2xl font-bold leading-tight tracking-tight sm:text-3xl">
          <span className="block text-amber-300">Kazuki Booking</span>
